...
from main import TCP_HOST, TCP_PORT, execute_many


# 각 Pico가 담당하는 센서 이름과 DB의 sensor_id를 연결한다.
DEVICE_SENSOR_MAP = {
...
# 각 Pico가 담당하는 액추에이터 이름과 DB의 actuator_id를 연결한다.
DEVICE_ACTUATOR_MAP = {
